...
K.set_learning_phase(1) # fit-1 / predict-0
...
ax1 = plt.subplot(211)
ax1.plot(hist.history['val_loss'],'r--',label = 'valid_loss')
ax1.plot(hist.history['loss'],'b',label = 'train_loss')
plt.legend(loc='best')
plt.ylabel('Loss')
plt.title('Loss')
ax2 = plt.subplot(212)
ax2.plot(hist.history['val_acc'],'r--',label = 'valid_acc')
ax2.plot(hist.history['acc'],'b',label = 'train_acc')
plt.legend(loc='best')
