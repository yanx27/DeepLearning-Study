...
4、深度卷积神经网络
-------
* 采用adagrad优化器，使用随机梯度下降法训练CNN模型。在cpu集群上训练了1000-2000小时。边界值\alpha 设定为0.2。总共实验了两类模型，参数如表4-1和表4-2所示。<br>
表4-1 CNN模型1<br>
...
* FaceNet在LFW数据集上取得了99.63%\pm 0.09的准确率；在Youtube Faces DB数据集上获得了95.12%\pm 0.39的结果。在个人照片的数据集上，对单个个体进行embeding后聚类测试，结果如图：<br>
![](https://pic3.zhimg.com/80/v2-5572fe254590986e917b77cbd1768a27_hd.jpg)
...
>* 以该模型为基础，将其用于现实应用开发中。
>* 减少模型大小，减少对cpu计算量的消耗，以及减少训练时间（作者在cpu集群上需要1000-2000小时的训练。）
